...
internal class VRFlashlight : VRItem<FlashlightItem>
{
    ...
    protected override void OnUpdate()
    {
        ...
        if (!item.isPocketed)
        {
            ...
            player.allHelmetLights[0].transform.ApplyOffsetTransform(networkPlayer.Bones.RightArmRigTarget, positionOffset, rotationOffset);
            player.allHelmetLights[1].transform.ApplyOffsetTransform(networkPlayer.Bones.RightArmRigTarget, positionOffset, rotationOffset);
            player.allHelmetLights[2].transform.ApplyOffsetTransform(networkPlayer.Bones.RightArmRigTarget, positionOffset, rotationOffset);
        }
